...
public class UniversityManagementSystem extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        TeacherRepository teacherRepository = new TeacherRepository(conn);
        TeacherService teacherService = new TeacherService(teacherRepository);
        loader.setControllerFactory(param -> new LoginViewController(userService,studentService,teacherService));
